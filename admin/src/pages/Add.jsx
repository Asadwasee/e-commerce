  ...
  const handleAddProduct = async (e) => {
    ...
    e.preventDefault()
      try {
        ...
        console.log(error);
        setLoading(false)
        toast.error("Product Adding Failed", { autoClose: 1000 });
    ...
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white overflow-x-hidden relative'>
      ...
      <div className="w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute right-0 bottom-[5%] ">
        <form action="" onSubmit={handleAddProduct} className='w-[100%] md:w-[90%] h-[100%] mt-[70px] flex flex-col gap-[30px] py-[60px] px-[30px] md:px-[60px] '>
          <div className="w-[400px] h-[50px] text-[21px] md:text-[30px] text-white">Add Product Page</div>
          <div className="w-[80%] h-[130px] flex items-start justify-center flex-col mt-[20px] gap-[10px] ">
            <p className='text-[18px] md:text-[22px] font-semibold '>Upload Image</p>
          ...
          <div className="w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] ">
            <p className='text-[18px] md:text-[22px] font-semibold '>Product Name</p>
          ...
          <div className="w-[80%] flex items-start justify-center flex-col gap-[10px] ">
            <p className='text-[18px] md:text-[22px] font-semibold '>Product Description</p>
          ...
          <div className="w-[80%] flex items-center gap-[10px] flex-wrap ">
            <div className="md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px] ">
              <p className='text-[18px] md:text-[22px] font-semibold w-[100%] '>Product Category</p>
            ...
            <div className="md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px] ">
              <p className='text-[18px] md:text-[22px] font-semibold w-[100%] '>Sub-Category</p>
              <select name="" id="" className='bg-slate-600 w-[60%] px-[12px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px] ' onChange={(e) => setSubCategory(e.target.value)} >
          ...
          <div className="w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] ">
            <p className='text-[18px] md:text-[22px] font-semibold '>Product Price</p>
          ...
          <div className="w-[80%] h-[220px] md:h-[100px] flex items-start justify-center flex-col gap-[10px] py-[10px] md:py-[0px] ">
            <p className='text-[18px] md:text-[22px] font-semibold '>Product Size</p>
          ...
          <div className="w-[80%] flex items-center justify-start gap-[10px] mt-[20px] ">
            ...
            <label htmlFor="checkbox" className='text-[17px] md:text-[20px] font-semibold '>
             Add to BestSeller
            </label>
          </div>

          <button className='w-[140px] px-[20px] py-[15px] rounded-xl bg-[#65d8f7] flex items-center justify-center gap-[10px] text-black active:bg-slate-700 active:text-white active:border-[2px] border-white font-semibold'>{loading ? <Loading /> : "Add Product"}</button>
